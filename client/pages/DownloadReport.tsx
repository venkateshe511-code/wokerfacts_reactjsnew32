                ...
                <table style="width: 100%; border-collapse: collapse; border: 1px solid #333; font-size: 8px; table-layout: auto;">
                  <thead>
                    <tr style="background: #f0f0f0;">
                      <th style="border: 1px solid #333; padding: 4px;">Stage</th>
                      <th style="border: 1px solid #333; padding: 4px;">Treadmill Speed</th>
                      <th style="border: 1px solid #333; padding: 4px;">Treadmill Incline</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr><td style="border: 1px solid #333; padding: 4px;">1</td><td style="border: 1px solid #333; padding: 4px;">1.7 mph</td><td style="border: 1px solid #333; padding: 4px;">10% grade</td></tr>
                    <tr><td style="border: 1px solid #333; padding: 4px;">2</td><td style="border: 1px solid #333; padding: 4px;">2.5 mph</td><td style="border: 1px solid #333; padding: 4px;">12% grade</td></tr>
                    <tr><td style="border: 1px solid #333; padding: 4px;">3</td><td style="border: 1px solid #333; padding: 4px;">3.4 mph</td><td style="border: 1px solid #333; padding: 4px;">14% grade</td></tr>
                    <tr><td style="border: 1px solid #333; padding: 4px;">4</td><td style="border: 1px solid #333; padding: 4px;">4.2 mph</td><td style="border: 1px solid #333; padding: 4px;">16% grade</td></tr>
                    <tr><td style="border: 1px solid #333; padding: 4px;">5</td><td style="border: 1px solid #333; padding: 4px;">5.0 mph</td><td style="border: 1px solid #333; padding: 4px;">18% grade</td></tr>
                    <tr><td style="border: 1px solid #333; padding: 4px;">6</td><td style="border: 1px solid #333; padding: 4px;">5.5 mph</td><td style="border: 1px solid #333; padding: 4px;">20% grade</td></tr>
                    <tr><td style="border: 1px solid #333; padding: 4px;">7</td><td style="border: 1px solid #333; padding: 4px;">6.0 mph</td><td style="border: 1px solid #333; padding: 4px;">22% grade</td></tr>
                  </tbody>
                </table>
              </div>
            </div>
            ...
            <div style="margin-bottom: 16px;">
              ...
              <div style="margin-bottom: 16px;">
                ...
                <table style="width: 100%; border-collapse: collapse; border: 1px solid #333; font-size: 7px; table-layout: auto;">
                  <thead>
                    <tr style="background: #f0f0f0;">
                      <th style="border: 1px solid #333; padding: 2px;">Age</th>
                      <th style="border: 1px solid #333; padding: 2px;">Excellent</th>
                      <th style="border: 1px solid #333; padding: 2px;">Good</th>
                      <th style="border: 1px solid #333; padding: 2px;">Above Average</th>
                      <th style="border: 1px solid #333; padding: 2px;">Average</th>
                      <th style="border: 1px solid #333; padding: 2px;">Below Average</th>
                      <th style="border: 1px solid #333; padding: 2px;">Poor</th>
                      <th style="border: 1px solid #333; padding: 2px;">Very Poor</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr><td style="border: 1px solid #333; padding: 2px;">20-29</td><td style="border: 1px solid #333; padding: 2px;">>56</td><td style="border: 1px solid #333; padding: 2px;">50-56</td><td style="border: 1px solid #333; padding: 2px;">46-49</td><td style="border: 1px solid #333; padding: 2px;">42-45</td><td style="border: 1px solid #333; padding: 2px;">37-41</td><td style="border: 1px solid #333; padding: 2px;">31-36</td><td style="border: 1px solid #333; padding: 2px;"><31</td></tr>
                    <tr><td style="border: 1px solid #333; padding: 2px;">30-39</td><td style="border: 1px solid #333; padding: 2px;">>54</td><td style="border: 1px solid #333; padding: 2px;">48-54</td><td style="border: 1px solid #333; padding: 2px;">44-47</td><td style="border: 1px solid #333; padding: 2px;">40-43</td><td style="border: 1px solid #333; padding: 2px;">35-39</td><td style="border: 1px solid #333; padding: 2px;">29-34</td><td style="border: 1px solid #333; padding: 2px;"><29</td></tr>
                    <tr><td style="border: 1px solid #333; padding: 2px;">40-49</td><td style="border: 1px solid #333; padding: 2px;">>52</td><td style="border: 1px solid #333; padding: 2px;">46-52</td><td style="border: 1px solid #333; padding: 2px;">42-45</td><td style="border: 1px solid #333; padding: 2px;">38-41</td><td style="border: 1px solid #333; padding: 2px;">33-37</td><td style="border: 1px solid #333; padding: 2px;">27-32</td><td style="border: 1px solid #333; padding: 2px;"><27</td></tr>
                    <tr><td style="border: 1px solid #333; padding: 2px;">50-59</td><td style="border: 1px solid #333; padding: 2px;">>50</td><td style="border: 1px solid #333; padding: 2px;">44-50</td><td style="border: 1px solid #333; padding: 2px;">40-43</td><td style="border: 1px solid #333; padding: 2px;">36-39</td><td style="border: 1px solid #333; padding: 2px;">31-35</td><td style="border: 1px solid #333; padding: 2px;">25-30</td><td style="border: 1px solid #333; padding: 2px;"><25</td></tr>
                    <tr><td style="border: 1px solid #333; padding: 2px;">60+</td><td style="border: 1px solid #333; padding: 2px;">>48</td><td style="border: 1px solid #333; padding: 2px;">42-48</td><td style="border: 1px solid #333; padding: 2px;">38-41</td><td style="border: 1px solid #333; padding: 2px;">34-37</td><td style="border: 1px solid #333; padding: 2px;">29-33</td><td style="border: 1px solid #333; padding: 2px;">23-28</td><td style="border: 1px solid #333; padding: 2px;"><23</td></tr>
                  </tbody>
                </table>
              </div>
              ...
              <div>
                ...
                <table style="width: 100%; border-collapse: collapse; border: 1px solid #333; font-size: 7px; table-layout: auto;">
                  ...
                  <tbody>
                    <tr><td style="border: 1px solid #333; padding: 2px;">20-29</td><td style="border: 1px solid #333; padding: 2px;">>49</td><td style="border: 1px solid #333; padding: 2px;">43-49</td><td style="border: 1px solid #333; padding: 2px;">39-42</td><td style="border: 1px solid #333; padding: 2px;">35-38</td><td style="border: 1px solid #333; padding: 2px;">31-34</td><td style="border: 1px solid #333; padding: 2px;">25-30</td><td style="border: 1px solid #333; padding: 2px;"><25</td></tr>
                    <tr><td style="border: 1px solid #333; padding: 2px;">30-39</td><td style="border: 1px solid #333; padding: 2px;">>47</td><td style="border: 1px solid #333; padding: 2px;">41-47</td><td style="border: 1px solid #333; padding: 2px;">37-40</td><td style="border: 1px solid #333; padding: 2px;">33-36</td><td style="border: 1px solid #333; padding: 2px;">29-32</td><td style="border: 1px solid #333; padding: 2px;">23-28</td><td style="border: 1px solid #333; padding: 2px;"><23</td></tr>
                    <tr><td style="border: 1px solid #333; padding: 2px;">40-49</td><td style="border: 1px solid #333; padding: 2px;">>45</td><td style="border: 1px solid #333; padding: 2px;">39-45</td><td style="border: 1px solid #333; padding: 2px;">35-38</td><td style="border: 1px solid #333; padding: 2px;">31-34</td><td style="border: 1px solid #333; padding: 2px;">27-30</td><td style="border: 1px solid #333; padding: 2px;">21-26</td><td style="border: 1px solid #333; padding: 2px;"><21</td></tr>
                    <tr><td style="border: 1px solid #333; padding: 2px;">50-59</td><td style="border: 1px solid #333; padding: 2px;">>43</td><td style="border: 1px solid #333; padding: 2px;">37-43</td><td style="border: 1px solid #333; padding: 2px;">33-36</td><td style="border: 1px solid #333; padding: 2px;">29-32</td><td style="border: 1px solid #333; padding: 2px;">25-28</td><td style="border: 1px solid #333; padding: 2px;">19-24</td><td style="border: 1px solid #333; padding: 2px;"><19</td></tr>
                    <tr><td style="border: 1px solid #333; padding: 2px;">60+</td><td style="border: 1px solid #333; padding: 2px;">>41</td><td style="border: 1px solid #333; padding: 2px;">35-41</td><td style="border: 1px solid #333; padding: 2px;">31-34</td><td style="border: 1px solid #333; padding: 2px;">27-30</td><td style="border: 1px solid #333; padding: 2px;">23-26</td><td style="border: 1px solid #333; padding: 2px;">17-22</td><td style="border: 1px solid #333; padding: 2px;"><17</td></tr>
                  </tbody>
                </table>
              </div>
            </div>
            ...
            <table style="width: 100%; border-collapse: collapse; font-size: 9px; margin-bottom: 8px;">
                ...
                <thead>
                    ...
                    <tr style="background: #fbbf24;">
                        <th style="border: 1px solid #333; padding: 4px; font-size: 8px;">Trial:</th>
                        <th style="border: 1px solid #333; padding: 4px; font-size: 8px;">Side:</th>
                        <th style="border: 1px solid #333; padding: 4px; font-size: 8px;">Weight/Plane:</th>
                        <th style="border: 1px solid #333; padding: 4px; font-size: 8px;">Distance/Posture:</th>
...
<div class="cover-page" style="height: 95vh; display: flex; flex-direction: column; text-align: center; padding: 25px 40px 15px 40px; box-sizing: border-box; max-height: 95vh; overflow: hidden;">
    ...
    <div style="padding: 40px 0 0 0; page-break-before: always; position: relative;">
        ...
        : `<div style="height: 16px; display: flex; align-items: center; justify-content: center; margin: 0 auto 8px auto;"><span style="font-size: 12px; font-weight: bold; color: #4472C4;">${evaluatorData.clinicName || "MedSource"
            ...
            <p style="font-size: 12px; color: #666; margin: 4px 0; font-family: Arial, sans-serif;">${evaluatorData.address || "Address"
      }</p>
            <p style="font-size: 12px; color: #666; margin: 4px 0; font-family: Arial, sans-serif;">Phone: ${evaluatorData.phone || "N/A"
            ...
            return `
                ...
                ? `
                                    ...
                                    <table style="width: 100%; border-collapse: collapse; font-size: 10px; margin: 8px 0 12px 0; table-layout: auto;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">${test.testName
                }</td>
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">${Math.max(
                  leftAvg,
                  rightAvg,
                ).toFixed(0)} deg</td>
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">${test.demonstrated
                  ? "Pass"
                  : "Fail"
                }</td>
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">${testName.includes("flexion")
                  ? "60 deg"
                  : testName.includes(
                    "extension",
                  )
                    ...
                    : "25 deg"
                                                ...
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">${Math.round(
                  (Math.max(leftAvg, rightAvg) /
                    (testName.includes(
                      "flexion",
                    )
                ...
                ? `
                                    ...
                                    <table style="width: 100%; border-collapse: collapse; font-size: 10px; margin: 8px 0 12px 0; table-layout: auto;">
                                        <thead>
                                            <tr style="background: #fef3c7;">
                                                <th style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">Demonstrated Activity</th>
                                                <th style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">Avg. Force (lb)</th>
                                                <th style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">Norm (lb)</th>
                                                <th style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">% age Norm</th>
                                                <th style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">% age CV</th>
                                                <th style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">Difference</th>
                                                <th style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">Test Date</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;"></td>
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">Left | Right</td>
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">L | R</td>
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">L | R</td>
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">L | R</td>
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">Prev | Total</td>
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;"></td>
                                            </tr>
                                            <tr>
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">${test.testName
                }</td>
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">${leftAvg.toFixed(
                  1,
                )} | ${rightAvg.toFixed(1)}</td>
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">${isGripTest
                  ? "110.5 | 120.8"
                  : "85.0 | 90.0"
                }</td>
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">${Math.round(
                  ...
                  100,
                                                ...
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">${leftCV}% | ${rightCV}%</td>
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">${bilateralDef.toFixed(
                  1,
                )}%</td>
                                                <td style="border: 1px solid #333; border-right: 1px solid #333; padding: 6px;">${currentDate}<br/>10:05:38 AM</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                `
                ...
                : ""
                                ...
                                ${test.effort
                ? `<p style="font-size: 11px; margin: 8px 0 12px 0;">*Rating of Perceived Effort = ${test.perceived || test.effort
                }</p>`
                : ""
              }
                ...
                return pre || post
                  ...
                  : "";
                            ...
                            <!-- Cardio Test Images -->
                            ${isCardioTest &&
                (test.clientImages || test.serializedImages)
                ? `
                                <div style="margin: 8px 0 12px 0; page-break-inside: avoid;">
                                    <h6 style="font-size: 10px; font-weight: bold; margin-bottom: 8px; color: #374151;">Test Images:</h6>
                  ...
                  .map((img, imageIndex) => {
                    try {
                      ...
                      return `
                                                <div style="text-align: center;">
                                                    <img src="${imageUrl}"
                                                         alt="${img.name || `${test.testName} test image ${imageIndex + 1}`}"
                                                         style="width: 80px; height: 60px; object-fit: cover; border: 1px solid #ccc; border-radius: 4px;" />
                                                    <p style="font-size: 8px; color: #6b7280; margin: 2px 0 0 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                                                        ${img.name || `Test Image ${imageIndex + 1}`}
                                                    </p>
                                                </div>
                                              `;
                    } catch (error) {
                  ...
                  .join("")}
                                    ...
                                    <div style="background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 4px; padding: 6px; margin: 6px 0;">
                                        <p style="font-size: 8px; color: #1e40af; margin: 0;">
                                            <strong>Note:</strong> The above images provide visual documentation of the ${test.testName} test procedures and results.
                                        </p>
                                    </div>
                                </div>
                                `
  ...
  const handleDownloadReport = async () => {
    ...
    if (selectedFormat === "pdf") {
      ...
      try {
        ...
        async function composePainViews(painData: any, baseUrls: string[]): Promise<string[]> {
          try {
            ...
            const markers: any[] = Array.isArray(painData?.markers) ? painData.markers : [];
            ...
            for (let i = 0; i < views.length; i++) {
              ...
              for (const m of viewMarkers) {
                ...
                const normX = isFiniteNumber(rawX)
                  ? (rawX <= 1 ? rawX * width : (rawX <= 100 ? (rawX / 100) * width : rawX))
                  : width / 2;
                const normY = isFiniteNumber(rawY)
                  ? (rawY <= 1 ? rawY * height : (rawY <= 100 ? (rawY / 100) * height : rawY))
                  : height / 2;
                ...
                switch (type) {
                  case "primary-concern":
                    derivedSymbol = "P1"; break;
                  case "secondary-concern":
                    derivedSymbol = "P2"; break;
                  case "dull-ache":
                    derivedSymbol = "~"; break;
                  case "shooting":
                    derivedSymbol = "/"; break;
                  case "burning":
                    derivedSymbol = "x"; break;
                  case "pins-needles":
                    derivedSymbol = "•"; break;
                  case "numbness":
                    derivedSymbol = "o"; break;
                  case "temperature":
                    derivedSymbol = "T"; break;
                  case "swelling":
                    derivedSymbol = "SW"; break;
                  case "scar":
                    derivedSymbol = "S"; break;
                  case "crepitus":
                    derivedSymbol = "C"; break;
                }
        ...
        const requestData = {
          ...
          painIllustrationData: {
            ...
            savedImageData:
              Array.isArray(painIllustrationData.savedImageData)
            ...
            compositedViews: composedViews && composedViews.length === 4 ? composedViews : imageUrls
          },
                ...
                ? digitalLibraryData.savedFileData
                  .filter((f: any) =>
                    typeof f?.type === "string"
                      ...
                      : !!(f?.dataUrl || f?.data || f?.url || f?.path || f?.src),
                  )
                  .map((f: any) => ({
                    name: f.name,
                    type: f.type,
