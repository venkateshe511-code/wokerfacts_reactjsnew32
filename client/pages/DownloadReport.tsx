                                ...
                                ${physicalDemandQuestion.savedImageData
                                  .map(
                                    ...
                                    <div style="width: 100%; height: 60px; overflow: hidden; border: 1px solid #333; border-radius: 3px;">
                                        <img src="${
                                          imageData.dataUrl || imageData.data
                                        }" alt="Physical Demand Assessment ${
                                          imgIndex + 1
                                        }" style="width: 100%; height: 100%; object-fit: cover;" />
                                    </div>
                                `,
                                                ...
                                                ${(() => {
                                                  ...
                                                  return `
                                                        <div style="width: 15%; display: flex; flex-direction: column; align-items: center;">
                                                            <div style="background: linear-gradient(to top, #1e40af, #3b82f6); width: 100%; height: ${
                                                              ((test
                                                                .leftMeasurements
                                                                .trial1 || 0) /
                                                                maxValue) *
                                                        ...
                                                        <div style="width: 15%; display: flex; flex-direction: column; align-items: center;">
                                                            <div style="background: linear-gradient(to top, #059669, #10b981); width: 100%; height: ${
                                                              ((test
                                                                .leftMeasurements
                                                                .trial2 || 0) /
                                                                maxValue) *
                                                        ...
                                                        <div style="width: 15%; display: flex; flex-direction: column; align-items: center;">
                                                            <div style="background: linear-gradient(to top, #d97706, #f59e0b); width: 100%; height: ${
                                                              ((test
                                                                .leftMeasurements
                                                                .trial3 || 0) /
                                                                maxValue) *
                                                        ...
                                                        <div style="width: 15%; display: flex; flex-direction: column; align-items: center;">
                                                            <div style="background: linear-gradient(to top, #dc2626, #ef4444); width: 100%; height: ${
                                                              ((test
                                                                .leftMeasurements
                                                                .trial4 || 0) /
                                                                maxValue) *
                                                        ...
                                                        <div style="width: 15%; display: flex; flex-direction: column; align-items: center;">
                                                            <div style="background: linear-gradient(to top, #7c3aed, #a855f7); width: 100%; height: ${
                                                              ((test
                                                                .leftMeasurements
                                                                .trial5 || 0) /
                                                                maxValue) *
                                                        ...
                                                        <div style="width: 15%; display: flex; flex-direction: column; align-items: center;">
                                                            <div style="background: linear-gradient(to top, #0891b2, #06b6d4); width: 100%; height: ${
                                                              ((test
                                                                .leftMeasurements
                                                                .trial6 || 0) /
                                                                maxValue) *
      ...
      try {
        ...
        const requestData = {
          ...
          claimantData: {
            ...
            height: claimantData.height || "",
            weight: claimantData.weight || "",
            address: claimantData.address || "",
            phoneNumber: claimantData.phoneNumber || "",
            email: claimantData.email || "",
            occupation: claimantData.currentOccupation || "",
            education: claimantData.educationLevel || "",
            handDominance: claimantData.handDominance || "Right",
