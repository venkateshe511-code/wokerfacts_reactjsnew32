...
import { countryData, countries, getAvailableCities, getPostalLabel, getPostalPlaceholder } from '@/lib/countryData';
...
export default function ClaimantForm() {
  ...
  const validateForm = () => {
    ...
    const missing = requiredFields.filter(field => !formData[field as keyof ClaimantData]);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-4 sm:py-8 px-2 sm:px-4">
      <div className="container mx-auto max-w-6xl">
        <div className="mb-8">
          <Button variant="outline" onClick={() => navigate('/dashboard')} className="mb-4 text-sm sm:text-base">
          ...
          <div className="text-center">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4 flex flex-col sm:flex-row items-center justify-center text-center">
              {isEditMode && <Edit className="mb-2 sm:mb-0 sm:mr-3 h-6 w-6 sm:h-8 sm:w-8 text-blue-600" />}
              Claimant Information
              {isEditMode && <span className="mt-2 sm:mt-0 sm:ml-3 text-lg sm:text-2xl text-blue-600">(Edit Mode)</span>}
            </h1>
        ...
        <Card className="shadow-lg">
          <CardHeader className={`text-white ${isEditMode ? 'bg-orange-600' : 'bg-blue-600'}`}>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onFocus={(e) => {
                        ...
                        setTimeout(() => {
                          try {
                            if (e.currentTarget && e.currentTarget.showPicker && typeof e.currentTarget.showPicker === 'function') {
              ...
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-4 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="dominantHand" className="text-sm font-medium">
                      Dominant Hand
                    </Label>
                    <Select onValueChange={(value) => handleInputChange('dominantHand', value)} value={formData.dominantHand}>
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex space-x-2">
                      <Input
                        ...
                        className="flex-1"
                      />
                      <Select onValueChange={(value) => handleInputChange('heightUnit', value)} value={formData.heightUnit}>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex space-x-2">
                      <Input
                        ...
                        className="flex-1"
                      />
                      <Select onValueChange={(value) => handleInputChange('weightUnit', value)} value={formData.weightUnit}>
                        <SelectTrigger className="w-20">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="restingPulse" className="text-sm font-medium">
                      Resting Pulse (BPM)
                    </Label>
                    <Input
                      id="restingPulse"
                      ...
                      onChange={(e) => handleInputChange('restingPulse', e.target.value)}
                      className="w-full"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => handleInputChange('bpSitting', e.target.value)}
                      className="w-full"
                    />
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <h3 className="text-lg font-semibold text-gray-900 border-b pb-2">Administrative Information</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  <div className="space-y-2">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="zipcode" className="text-sm font-medium">
                        {getPostalLabel(formData.country)} {formData.zipcode && <span className="text-green-600 text-xs">(Auto-filled)</span>}
                      </Label>
                      <Input
                        id="zipcode"
                        type="text"
              ...
              {/* Claimant History */}
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-900 border-b pb-2">Claimant History</h3>
                <div className="space-y-2">
                  <Label htmlFor="claimantHistory" className="text-sm font-medium">
                    Medical History & Injury Details
                  </Label>
                  <Textarea
                    id="claimantHistory"
                    value={formData.claimantHistory}
                    onChange={(e) => handleInputChange('claimantHistory', e.target.value)}
                ...
                >
                  {isSubmitting ? (
                    ...
                    <div className="flex items-center justify-center">
                      ...
                      {isEditMode ? 'Update Claimant Data' : 'Save Claimant Data'}
                    </div>
                  )}
                </Button>
              </div>
